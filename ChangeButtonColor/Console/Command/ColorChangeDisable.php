...
class ColorChangeDisable extends Command
{
    ...
    protected function execute(
        ...
        try {
            ...
            $this->changeButtonColorConfiguration->setIsEnabled(0, $store->getId());
    ...
    {
        $this->setName("color:change:disable");
        $this->setDescription("Disable change buttons color");
        $this->setDefinition([
